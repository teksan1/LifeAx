  ...
  if (isAuthenticated && user) {
    return (
      <div className="min-h-screen bg-background text-foreground">
        {/* Header */}
        <div className="border-b-2 border-foreground px-4 md:px-8 py-4 md:py-6">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
            <h1 className="text-3xl md:text-5xl font-black uppercase">LIFEAX</h1>
            <div className="text-right text-sm">
              <p className="font-bold uppercase text-muted-foreground text-xs">Welcome</p>
        ...
        {/* Main Content */}
        <div className="max-w-6xl mx-auto px-3 md:px-8 py-6 md:py-12">
          <div className="mb-8 md:mb-12">
            <h2 className="text-2xl md:text-4xl font-black uppercase mb-3 md:mb-4">Your Life Optimization Dashboard</h2>
          ...
          {/* Quick Access Grid */}
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 mb-8 md:mb-12">
            <button
              onClick={() => setLocation("/chat")}
              className="border-2 border-foreground p-3 md:p-6 bg-background hover:bg-foreground hover:text-background transition-all text-left group"
            >
              <MessageSquare size={24} className="mb-2 md:mb-3 group-hover:scale-110 transition-transform" />
              <h3 className="font-black uppercase text-sm md:text-lg mb-1 md:mb-2">AI Chat</h3>
              <p className="text-xs md:text-sm text-muted-foreground group-hover:text-background/70">Get personalized advice</p>
            </button>
            ...
            <button
              ...
              className="border-2 border-foreground p-3 md:p-6 bg-background hover:bg-foreground hover:text-background transition-all text-left group"
            >
              <Calendar size={24} className="mb-2 md:mb-3 group-hover:scale-110 transition-transform" />
              <h3 className="font-black uppercase text-sm md:text-lg mb-1 md:mb-2">Calendar</h3>
              <p className="text-xs md:text-sm text-muted-foreground group-hover:text-background/70">Manage your schedule</p>
            </button>
            ...
            <button
              ...
              className="border-2 border-foreground p-3 md:p-6 bg-background hover:bg-foreground hover:text-background transition-all text-left group"
            >
              <CheckSquare size={24} className="mb-2 md:mb-3 group-hover:scale-110 transition-transform" />
              <h3 className="font-black uppercase text-sm md:text-lg mb-1 md:mb-2">Tasks</h3>
              <p className="text-xs md:text-sm text-muted-foreground group-hover:text-background/70">Track your goals</p>
            </button>
            ...
            <button
              ...
              className="border-2 border-foreground p-3 md:p-6 bg-background hover:bg-foreground hover:text-background transition-all text-left group"
            >
              <Bell size={24} className="mb-2 md:mb-3 group-hover:scale-110 transition-transform" />
              <h3 className="font-black uppercase text-sm md:text-lg mb-1 md:mb-2">Alerts</h3>
              <p className="text-xs md:text-sm text-muted-foreground group-hover:text-background/70">Stay informed</p>
            </button>
